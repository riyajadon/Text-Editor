...
from tkinter import ttk   # Used for adding widget
from tkinter import font, colorchooser, filedialog, messagebox
import os
main_application = tk.Tk()
main_application.geometry("1200x800")
main_application.title('Jpad text editor')
...
tool_bar.pack(side=tk.TOP, fill=tk.X)  # Use to adjust label into the window
font_tuple = tk.font.families()
font_family = tk.StringVar()   # Takes string user input
...
underline_btn.grid(row=0, column=4, padx=6)
...
view.add_checkbutton(label="Tool Bar",onvalue=1, offvalue=False, variable=show_toolbar,
